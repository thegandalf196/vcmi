...
const JsonNode & CGameInfoCallback::getHeroCapabilityRules() const
{
	return gameState().getHeroCapabilityRules();
}

const JsonNode & CGameInfoCallback::getHeroMasteryRules() const
{
