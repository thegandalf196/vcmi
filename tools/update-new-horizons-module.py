...
def main():
    ...
    metadata = {
        ...
        'description': 'Curated rules: three Orders (including targeted Focus Fire) and '
                       ...
                       'use supplied animated Mage Guild artwork and the Stronghold ridge swap. '
                       'See assets/new-horizons/Mage Guilds for provenance and validation. '
        ...
        'licenseName': 'GPL-2.0-or-later; independently authored artwork CC0-1.0; supplied Mage Guild assets retain original rights',
