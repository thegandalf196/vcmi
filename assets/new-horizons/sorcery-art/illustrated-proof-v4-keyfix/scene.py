...
keyroot=bpy.data.objects.new('KEY / original warding key',None);bpy.context.collection.objects.link(keyroot);keyroot.parent=bookroot;keyroot.location=(.10,-.12,.875);keyroot.scale=(1.23,1.30,1);keyroot.rotation_euler=(0,0,math.radians(-30))
