...
d.text((8,8),'V4 ILLUSTRATIVE TEST / NOT APPROVED',fill='white')
...
previous=ROOT.parent/'still-life-proof-v3'/'output'
comparison=Image.new('RGB',(320,208),'#706351');cd=ImageDraw.Draw(comparison)
for row,(folder,label) in enumerate([(previous,'V3: user says too photorealistic'),(OUT,'V4: illustrative refinement TEST')]):
